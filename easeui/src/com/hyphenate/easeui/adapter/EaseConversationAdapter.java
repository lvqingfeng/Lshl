...
public class EaseConversationAdapter extends ArrayAdapter<EMConversation> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (holder == null) {
            ...
            holder.avatar = (ImageView) convertView.findViewById(avatar);
        ...
        if (conversation.getType() == EMConversationType.GroupChat) {
            ...
            EaseUserUtils.setGoupAvatar(username, holder.avatar);
            ...
            EaseUserUtils.setUserShow(username, holder.name, holder.avatar);
        /*    EaseUserUtils.setUserAvatar( username, holder.avatar);
            EaseUserUtils.setUserNick(username, holder.name);*/
            final String newAvatar = EaseUserUtils.getUserInfo(username).getAvatar();
            holder.motioned.setVisibility(View.GONE);
    ...
    private void seeBigImg(String newAvatar) {
        ImageView imgView = new ImageView(mContext);
        imgView.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));

        Glide.with(mContext).load(newAvatar).placeholder(R.drawable.account_logo).error(R.drawable.account_logo).into(imgView);
