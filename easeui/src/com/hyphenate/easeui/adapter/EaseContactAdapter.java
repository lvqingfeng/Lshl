...
//        if (convertView == null) {
        ...
        holder.grade = (ImageView) convertView.findViewById(R.id.grade);
...
//        }
        ...
        EaseUserUtils.setUserAddress(username, holder.address);
        EaseUserUtils.setUserShow(username, holder.nameView, holder.avatar);
    ...
    private void seeBigImg() {
        ...
        Glide.with(mContext).load(avatar).placeholder(R.drawable.account_logo).error(R.drawable.account_logo).into(imgView);
