...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected int[] itemdrawables = {R.drawable.ease_chat_takepic, R.drawable.ease_chat_image,
            R.drawable.ease_chat_location};
    ...
    public EaseChatMessageList getChatMessageList() {
        return messageList;
    }
    ...
    protected void initView() {
        ...
        inputMenu.setChatInputMenuListener(new ChatInputMenuListener() {
            ...
            public void onSendMessage(String content) {
                Log.d("发出消息：", "ChatInputMenuListener:" + content);
            ...
            public boolean onPressToSpeakBtnTouch(View v, MotionEvent event) {
                return voiceRecorderView.onPressToSpeakBtnTouch(v, event, new EaseVoiceRecorderCallback() {
                    ...
                    public void onVoiceRecordComplete(String voiceFilePath, int voiceTimeLength) {
                        Log.d("发出消息：", "发送视频类型 ---- 地址 = :" + voiceFilePath);
        ...
        switch (type) {
            case TXT:
                if (forward_msg.getBooleanAttribute(EaseConstant.MESSAGE_ATTR_IS_BIG_EXPRESSION, false)) {
                    ...
                    Log.d("发出消息：", "forwardMessage:" + content);
                    sendTextMessage(content);
                }
                break;
            case IMAGE:
