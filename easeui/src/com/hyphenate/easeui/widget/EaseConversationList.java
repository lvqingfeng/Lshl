...
public class EaseConversationList extends ListView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        primaryColor = ta.getColor(R.styleable.EaseConversationList_cvsListPrimaryTextColor, ContextCompat.getColor(context,R.color.list_itease_primary_color));
        secondaryColor = ta.getColor(R.styleable.EaseConversationList_cvsListSecondaryTextColor,ContextCompat.getColor(context,R.color.list_itease_secondary_color));
        timeColor = ta.getColor(R.styleable.EaseConversationList_cvsListTimeTextColor, ContextCompat.getColor(context,R.color.list_itease_secondary_color));
