        ...
        if (bitmap != null) {
            ...
            new AsyncTask<Object, Void, Bitmap>() {
                ...
                protected Bitmap doInBackground(Object... args) {
                    ...
                    if (file.exists()) {
                        return EaseImageUtils.decodeScaleImage(thumbernailPath, 180, 180);
                    } else if (new File(imgBody.thumbnailLocalPath()).exists()) {
                        return EaseImageUtils.decodeScaleImage(imgBody.thumbnailLocalPath(), 180, 180);
                    }
                    else {
                        if (message.direct() == EMMessage.Direct.SEND) {
                            if (localFullSizePath != null && new File(localFullSizePath).exists()) {
                                return EaseImageUtils.decodeScaleImage(localFullSizePath, 180, 180);
                            } else {
                                return null;
                            }
                        } else {
