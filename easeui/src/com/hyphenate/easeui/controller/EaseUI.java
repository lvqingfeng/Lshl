...
public final class EaseUI {
    ...
    public interface EaseUserProfileProvider {
        ...
        void setUserAvatar(TextView name, ImageView avatar, String hxId,String flag);

        void setHxAvatar(String url, ImageView view);

        EaseGroup getGroup(String groupId);

        void getTempUser(String username, EaseUserUtils.EMUserInfoCallback callback);

        void getTempUserList(String hxIds, EaseUserUtils.EMUserListCallback callback);

        String getFriendRealName(String hxName);
    }
