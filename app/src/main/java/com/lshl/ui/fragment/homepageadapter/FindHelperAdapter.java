...
public class FindHelperAdapter extends RecyclerView.Adapter<BindingViewHolder<ItemLayoutHomepageGoodsBinding>> {
    private List<HomePageBean.InfoBean.FindhelperBean> mList;

    public FindHelperAdapter(List<HomePageBean.InfoBean.FindhelperBean> mList) {
        this.mList = mList;
    }
    ...
    public void onBindViewHolder(BindingViewHolder<ItemLayoutHomepageGoodsBinding> holder, int position) {
        HomePageBean.InfoBean.FindhelperBean bean = mList.get(position);
