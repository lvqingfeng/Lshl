...
public class YearRankAdapter extends RecyclerView.Adapter<BindingViewHolder<RecyclerItemRankBinding>> {
    private List<RankBean.InfoEntity.ListEntity> mList;

    public YearRankAdapter(List<RankBean.InfoEntity.ListEntity> mList) {
        this.mList = mList;
    }
