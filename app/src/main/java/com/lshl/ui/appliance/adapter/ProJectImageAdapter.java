...
public class ProJectImageAdapter extends RecyclerView.Adapter<BindingViewHolder<ItemLayoutImageBinding>> {
    private List<String> mList;

    public ProJectImageAdapter(List<String> mList) {
        this.mList = mList;
    }
    ...
    public void onBindViewHolder(BindingViewHolder<ItemLayoutImageBinding> holder, int position) {
        ...
        Glide.with(holder.mContext).load(s).into(holder.getBinding().imageView);
