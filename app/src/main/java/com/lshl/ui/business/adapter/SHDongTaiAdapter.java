...
public class SHDongTaiAdapter extends RecyclerView.Adapter<BindingViewHolder<RecyclerItemDongtaiBinding>> {
    private List<DongTaiBean.InfoEntity.ListEntity> mList;

    public SHDongTaiAdapter(List<DongTaiBean.InfoEntity.ListEntity> mList) {
        this.mList = mList;
    }
