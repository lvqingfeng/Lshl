...
//                                        callStateTextView.setText(st7);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_refuse_call://挂断的点击事件,当别人给你打电话的时
                refuseBtn.setEnabled(false);
                handler.sendEmptyMessage(MSG_CALL_REJECT);
                break;

            case R.id.btn_answer_call://接听的点击事件
            ...
            case R.id.btn_hangup_call://挂断的点击事件,当主动拨号的时候
            ...
            case R.id.iv_mute://静音的点击事件
                ...
                break;
            case R.id.iv_handsfree://免提的点击事件
                if (isHandsfreeState) {
