...
import com.lshl.R;
import com.lshl.bean.VideoEntity;
import com.lshl.video.util.ImageCache;
import com.lshl.video.util.ImageResizer;
import com.lshl.video.util.Utils;
import com.lshl.widget.RecyclingImageView;
	...
	private class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup container) {
			 ...
			 if(convertView==null)
			 {
				 ...
				 convertView=LayoutInflater.from(mContext).inflate(R.layout.item_choose_grid, container,false);
