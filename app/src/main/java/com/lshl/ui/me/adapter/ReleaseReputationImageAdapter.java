...
import com.lshl.databinding.AddImageFooterBinding;
import com.lshl.databinding.ReleaseReputationImageBinding;
import com.lshl.ui.me.imagegrid.ImageGridActivity;

import java.util.ArrayList;
import java.util.List;

import static com.lshl.ui.me.activity.ReleaseReputationActivity.MAX_IMAGE;
...
public class ReleaseReputationImageAdapter extends RecyclerView.Adapter<BindingViewHolder> {
    ...
    public ReleaseReputationImageAdapter(Activity mActivity,int mRequestCode, int MAX_Image) {
        ...
        mImageSize = LshlApplication.sWindowWidth / 3;
    ...
    public void onBindViewHolder(BindingViewHolder holder, int position) {
        ...
        switch (itemType) {
            case IMAGE_ITEM:
                ...
                itemBinding.setImageSize(mImageSize);
                itemBinding.setImageUrl(mListData.get(position));
                break;
            case ADD_IMAGE:
