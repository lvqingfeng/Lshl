package com.lshl.ui.me.imagegrid.photo_show;
...
import com.lshl.ui.me.imagegrid.ImageSelectManage;
import com.lshl.ui.me.imagegrid.adapter.ImageViewPagerAdapter;
import com.lshl.ui.me.imagegrid.bean.ImageBucket;
import com.lshl.ui.me.imagegrid.bean.ImageItem;
import com.lshl.ui.me.imagegrid.utils.ImmersiveUtil;
import com.lshl.ui.me.imagegrid.utils.InOutAnimationUtils;
import com.lshl.ui.me.imagegrid.widget.HackyViewPager;
...
public class PhotoShowActivity extends AppCompatActivity implements OnImageClickCallback {
    ...
    private void initData() {
        ...
        //从数据库中获取数据
        List<ImageBucket> imageBuckets = LshlApplication.getApplication().getImageBucket();
