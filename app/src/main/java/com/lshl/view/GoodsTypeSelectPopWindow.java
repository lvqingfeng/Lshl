...
public class GoodsTypeSelectPopWindow extends AddPopWindow {
    ...
    private GoodsTypeSelectPopWindow.WheelChangeListener mChangeListener;
     ...
     * @param context 上下文对象
     */
    public GoodsTypeSelectPopWindow(Activity context) {
    ...
    private void initData(Context context) {
        try {
            mAddressData = JsonFormFileUtils.getJsonArray(context, "goods_type.json", AddressBean.class);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }

    public void setWheelChangeListener(GoodsTypeSelectPopWindow.WheelChangeListener listener) {
