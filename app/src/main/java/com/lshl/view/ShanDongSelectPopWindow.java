...
public class ShanDongSelectPopWindow extends AddPopWindow{
    ...
    private AddressSelectPopWindow.WheelChangeListener mChangeListener;
     ...
     * @param context 上下文对象
     */
    public ShanDongSelectPopWindow(Activity context) {
    ...
    private void initData(Context context) {
        try {
            mAddressData = JsonFormFileUtils.getJsonArray(context, "shandong.json", AddressBean.class);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }

    public void setWheelChangeListener(AddressSelectPopWindow.WheelChangeListener listener) {
