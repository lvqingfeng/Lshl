...
public abstract class BaseActivity<D extends ViewDataBinding> extends AppCompatActivity {
    ...
    protected void checkUserIsDonation(TaskBase.CheckUserAuthortyCallBack callBack) {
        TaskBase.checkUserIsDonation(mContext, callBack);
    }
    ...
    protected void checkUserIsDues(TaskBase.CheckUserAuthortyCallBack callBack){
        TaskBase.checkUserIsDues(mContext,callBack);
    }
    /**
     * 屏幕变亮
     */
