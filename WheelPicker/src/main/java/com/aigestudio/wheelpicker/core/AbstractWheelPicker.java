...
public abstract class AbstractWheelPicker extends View implements IWheelPicker {
    ...
    protected void obtainAttrs(AttributeSet attrs) {
        ...
        if (null != attrs) {
            ...
            textSize = a.getDimensionPixelSize(
                    R.styleable.AbstractWheelPicker_wheel_text_size, sp2px(getContext(), defTextSize));
            ...
            textSize = sp2px(getContext(), defTextSize);
    ...
    /**
     * 将sp转换为像素，因为在View设置TextSize是设置的像素值
     *
     * @param context
     * @param spValue
     * @return
